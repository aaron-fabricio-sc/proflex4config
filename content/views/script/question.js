...
$MOD$ question.js 4.3.1-201021-21-23fb68fb-1a04bc7d
 */
...
define(['knockout', 'code-behind/baseaggregate', 'vm-util/UICommanding', 'vm/MessageViewModel'], function(ko, base, commanding) {
    ...
    return /** @alias module:question */ base.extend({
        ...
        compositionUpdated: function() {
            _logger.log(_logger.LOG_DETAIL, "* | VIEW_AGGREGATE question:compositionUpdated");
            base.compositionUpdated();
            let mainVM = base.container.getById("flexMain");
            mainVM && typeof mainVM.compositionUpdatedObservable === "function" && mainVM.compositionUpdatedObservable(Date.now());
            base.container.whenActivated().then(() => {
