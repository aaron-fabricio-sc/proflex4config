...
$MOD$ prepaidproviderselection.js 4.3.1-201021-21-23fb68fb-1a04bc7d
 */

/**
 * The prepaidproviderselection code-behind provides the life-cycle for the <i>prepaidproviderselection</i> view.
 * @module prepaidproviderselection
 * 1.0/10
 */
define(['code-behind/baseaggregate', 'vm/ListViewModel'], function(base) {
    ...
    return /** @alias module:prepaidproviderselection */ base.extend({
        name: "prepaidproviderselection",
         ...
         */
        activate: function() {
            _logger.log(_logger.LOG_DETAIL, "* | VIEW_AGGREGATE prepaidproviderselection:activate");
        ...
        compositionComplete: function(view, parent) {
            _logger.log(_logger.LOG_DETAIL, "* | VIEW_AGGREGATE prepaidproviderselection:compositionComplete");
