...
$MOD$ DepositNotesRemovalOutput.js 4.3.1-200122-21-0cd8a9f7-1a04bc7d
 */

/**
 * @module flowactionplugins/DepositNotesRemovalOutput
 */
define(["extensions", "./util/pluginHelper", "./util/cashHelper"], function(ext, plugInHelper, cashHelper) {
    "use strict";
    console.log("AMD:DepositNotesRemovalOutput");
    ...
    return {
        ...
        onActivateReady: async function(context) {
            try {
                cashHelper.updateDepositCommandStates();
                return await plugInHelper.processTimeout(context);
            } catch(e) {
                throw `FlowAction plug-in DepositNotesRemovalOutput::onActivateReady has been failed ${e}`;
            }
        },
