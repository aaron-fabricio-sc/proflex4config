...
$MOD$ WithdrawalNotesAndCoinsAndReceiptPresentation.js 4.3.1-200122-21-0cd8a9f7-1a04bc7d
 */

/**
 * @module flowactionplugins/WithdrawalNotesAndCoinsAndReceiptPresentation
 */
define(["extensions", "./util/pluginHelper", "./util/cashHelper"], function(ext, plugInHelper, cashHelper) {
    "use strict";
    console.log("AMD:WithdrawalNotesAndCoinsAndReceiptPresentation");
    ...
    return {
        ...
        onPrepare: async function(context) {
            try {
                ...
                throw `FlowAction plug-in WithdrawalNotesAndCoinsAndReceiptPresentation has been failed ${e}`;
            }
        },
        ...
        onActivateReady: async function(context) {
            try {
                ...
                throw `FlowAction plug-in WithdrawalNotesAndCoinsAndReceiptPresentation::onActivateReady has been failed ${e}`;
            }
        },
