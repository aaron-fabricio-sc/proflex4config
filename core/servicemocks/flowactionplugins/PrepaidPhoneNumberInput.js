...
$MOD$ PrepaidPhoneNumberInput.js 4.3.1-200512-21-e0b258da-1a04bc7d
 */

/**
 * @module flowactionplugins/PrepaidPhoneNumberInput
 */
define(["extensions"], function(ext) {
    "use strict";
    console.log("AMD:PrepaidPhoneNumberInput");
        ...
        onGuiResult: async function(context) {
            try {
                if(context.action === "CONFIRM") {
                    ...
                    await _dataService.setValues("CCTAFW_PROP_CUSTOMER_INPUT_VARIABLE[43]", result["CCTAFW_PROP_UI_INPUT_FIELD_CONTENT_UNFORMATTED[0]"], null);
                }
            } catch(e) {
                throw `FlowAction plug-in PrepaidPhoneNumberInput::onGuiResult has been failed ${e}`;
            }
        }
    };
});
