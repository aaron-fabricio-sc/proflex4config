...
$MOD$ TransferAmountInput.js 4.3.1-200122-21-0cd8a9f7-1a04bc7d
 */
/**
 * @module flowactionplugins/TransferAmountInput
 */
define(["extensions"], function(ext) {
    "use strict";
    console.log("AMD:TransferAmountInput");
    ...
    return {
        ...
        onGuiResult: async function(context) {
            try {
                ...
                throw `FlowAction plug-in TransferAmountInput::onGuiResult has been failed ${e}`;
            }
        }
    };
});
