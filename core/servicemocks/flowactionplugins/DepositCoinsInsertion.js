...
$MOD$ DepositCoinsInsertion.js 4.3.1-200122-21-0cd8a9f7-1a04bc7d
 */

/**
 * @module flowactionplugins/DepositCoinsInsertion
 */
define(["extensions", "./util/cashHelper"], function(ext, cashHelper) {
    "use strict";
    console.log("AMD:DepositCoinsInsertion");
    ...
    return {
        ...
        onPrepare: function(context) {
            return ext.Promises.promise(async (resolve, reject) => {
                try {
                    ...
                    reject("FlowAction plug-in DepositCoinsInsertion::onPrepare has been failed " + e);
                }
        ...
        onActivateReady: function(context) {
            return ext.Promises.promise((resolve, reject) => {
                try {
                    ...
                    reject("FlowAction plug-in DepositCoinsInsertion::onActivateReady has been failed " + e);
                }
            });
        },
        ...
        onGuiResult: function(context) {
            return ext.Promises.promise((resolve, reject) => {
                try {
                    _dataService.setValues(["PROP_PENULTIMATE_ACTION"], [context.action], null).then(() => {
                        resolve();
                    });
                } catch(e) {
                    reject("FlowAction plug-in DepositCoinsInsertion::onGuiResult has been failed " + e);
                }
            });
        }
    };
