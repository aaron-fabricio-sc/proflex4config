...
$MOD$ PinChangePinConfirmation.js 4.3.1-200122-21-0cd8a9f7-1a04bc7d
 */

/**
 * @module flowactionplugins/PinChangePinConfirmation
 */
define(["jquery", "extensions", "./util/pluginHelper"], function(jQuery, ext, pluginHelper) {
    "use strict";
    console.log("AMD:PinChangePinConfirmation");
    ...
    return {
        ...
        onActivateReady: async function(context) {
            try {
                ...
                throw `FlowAction plug-in PinChangePinConfirmation::onActivateReady has been failed ${e}`;
            }
        },
        /**
