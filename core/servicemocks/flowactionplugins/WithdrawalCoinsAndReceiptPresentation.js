...
$MOD$ WithdrawalCoinsAndReceiptPresentation.js 4.3.1-200122-21-0cd8a9f7-1a04bc7d
 */

/**
 * @module flowactionplugins/WithdrawalCoinsAndReceiptPresentation
 */
define(["extensions", "./util/cashHelper"], function(ext, cashHelper) {
    "use strict";
    console.log("AMD:WithdrawalCoinsAndReceiptPresentation");
