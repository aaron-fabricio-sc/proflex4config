...
$MOD$ OrderAmountSelection.js 4.3.1-200122-21-0cd8a9f7-1a04bc7d
 */

/**
 * @module flowactionplugins/OrderAmountSelection
 */
define(["extensions"], function(ext) {
    "use strict";
    console.log("AMD:OrderAmountSelection");
    ...
    return {
        ...
        onActivateReady: function(context) {
            return ext.Promises.promise((resolve, reject) => {
                try {
                    ...
                    reject(`FlowAction plug-in OrderAmountSelection::onActivateReady has been failed ${e}`);
                }
            });
        },
        ...
        onHardwareEvent: async function(context) {
            try {
                ...
                throw `FlowAction plug-in OrderAmountSelection::onHardwareEvent has been failed ${e}`;
            }
        },
        ...
        onGuiResult: async function(context) {
            try {
                ...
                throw `FlowAction plug-in OrderAmountSelection::onGuiResult has been failed ${e}`;
            }
        }
    };
});
