...
$MOD$ DepositChequesReadingChequesWait.js 4.3.1-200122-21-0cd8a9f7-1a04bc7d
 */

/**
 * @module flowactionplugins/DepositChequesReadingChequesWait
 */
define(["extensions", "./util/cashHelper"], function(ext, cashHelper) {
    "use strict";
    console.log("AMD:DepositChequesReadingChequesWait");
            ...
            return ext.Promises.promise(async (resolve, reject) => {
                try {
                    ...
                    for(let i = 0; i < chkCount; i++) {
                        setTimeout(async () => {
                            if(context.currentViewKey() === "DepositChequesReadingChequesWait") { // check whether we are in cheque scan still
                    ...
                    reject("FlowAction plug-in DepositChequesReadingChequesWait::onActivateReady has been failed " + e);
                }
            });
        },
