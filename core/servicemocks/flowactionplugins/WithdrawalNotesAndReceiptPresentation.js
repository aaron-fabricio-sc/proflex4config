...
$MOD$ WithdrawalNotesAndReceiptPresentation.js 4.3.1-200122-21-0cd8a9f7-1a04bc7d
 */

/**
 * @module flowactionplugins/WithdrawalNotesAndReceiptPresentation
 */
define(["extensions", "./util/pluginHelper", "./util/cashHelper"], function(ext, plugInHelper, cashHelper) {
    "use strict";
    console.log("AMD:WithdrawalNotesAndReceiptPresentation");
    ...
    return {
        ...
        onActivateReady: async function(context) {
            try {
                ...
                throw `FlowAction plug-in WithdrawalNotesAndReceiptPresentation::onActivateReady has been failed ${e}`;
            }
        },
