...
$MOD$ OrderUnitInput.js 4.3.1-200512-21-e0b258da-1a04bc7d
 */

/**
 * @module flowactionplugins/OrderUnitInput
 */
define(["extensions"], function(ext) {
    "use strict";
    console.log("AMD:OrderUnitInput");
    ...
    return {
        ...
        onGuiResult: async function(context) {
            try {
                ...
                throw `FlowAction plug-in OrderUnitInput::onGuiResult has been failed ${e}`;
            }
        }
    };
});
