...
$MOD$ WithdrawalMultiBundleNotesPresentation.js 4.3.1-200122-21-0cd8a9f7-1a04bc7d
 */

/**
 * @module flowactionplugins/WithdrawalMultiBundleNotesPresentation
 */
define(["extensions", "./util/pluginHelper", "./util/cashHelper"], function(ext, plugInHelper, cashHelper) {
    "use strict";
    console.log("AMD:WithdrawalMultiBundleNotesPresentation");
    ...
    return {
        ...
        onPrepare: async function(context) {
            try {
                ...
                throw `FlowAction plug-in WithdrawalMultiBundleNotesPresentation has been failed ${e}`;
            }
        },
        ...
        onActivateReady: async function(context) {
            try {
                ...
                throw `FlowAction plug-in WithdrawalMultiBundleNotesPresentation::onActivateReady has been failed ${e}`;
            }
        },
