...
$MOD$ WithdrawalMultiBundleNotesAndCoinsPresentation.js 4.3.1-200122-21-0cd8a9f7-1a04bc7d
 */

/**
 * @module flowactionplugins/WithdrawalMultiBundleNotesAndCoinsPresentation
 */
define(["extensions", "./util/pluginHelper", "./util/cashHelper"], function(ext, plugInHelper, cashHelper) {
    "use strict";
    console.log("AMD:WithdrawalMultiBundleNotesAndCoinsPresentation");
    ...
    return {
        ...
        onPrepare: async function(context) {
            try {
                ...
                throw `FlowAction plug-in WithdrawalMultiBundleNotesAndCoinsPresentation has been failed ${e}`;
            }
        },
        ...
        onActivateReady: async function(context) {
            try {
                ...
                `FlowAction plug-in WithdrawalMultiBundleNotesAndCoinsPresentation::onActivateReady has been failed ${e}`;
            }
        },
