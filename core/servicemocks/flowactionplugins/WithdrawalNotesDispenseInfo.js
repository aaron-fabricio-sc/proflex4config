...
$MOD$ WithdrawalNotesDispenseInfo.js 4.3.1-200122-21-0cd8a9f7-1a04bc7d
 */

/**
 * @module flowactionplugins/WithdrawalNotesDispenseInfo
 */
define(["extensions", "./util/cashHelper"], function(ext, cashHelper) {
    "use strict";
    console.log("AMD:WithdrawalNotesDispenseInfo");
        ...
        onActivateReady: async function(context) {
            try {
                if(_controlPanelService.getContext().moreOptionsViewModel && _controlPanelService.getContext().moreOptionsViewModel.enableMoveOnWait()) {
                    ...
                    if(context.currentViewKey() === "WithdrawalNotesDispenseInfo") {
                        return "*";
                    }
                }
            } catch(e) {
                throw `FlowAction plug-in WithdrawalNotesDispenseInfo::onActivateReady has been failed ${e}`;
            }
        },
