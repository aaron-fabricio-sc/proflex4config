...
$MOD$ DepositNotesRemovalInput.js 4.3.1-200122-21-0cd8a9f7-1a04bc7d
 */

/**
 * @module flowactionplugins/DepositNotesRemovalInput
 */
define(["extensions", "./util/pluginHelper", "./util/cashHelper"], function(ext, plugInHelper, cashHelper) {
    "use strict";
    console.log("AMD:DepositNotesRemovalInput");
    ...
    return {
        ...
        onPrepare: async function(context) {
            try {
                ...
                throw `FlowAction plug-in DepositNotesRemovalInput::onPrepare has been failed ${e}`;
            }
        },
        ...
        onActivateReady: async function(context) {
            try {
                ...
                throw `FlowAction plug-in DepositNotesRemovalInput::onActivateReady has been failed ${e}`;
            }
        },
