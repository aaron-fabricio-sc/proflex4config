/*
 $MOD$ accountselection_test.js 4.3.1-210511-21-5ea44998-1a04bc7d
 */
...
define(['lib/Squire'], function (Squire) {
    ...
    describe("accountselection code-behind", () => {
        ...
        describe("life-cycle", () => {
            it("compositionUpdated refreshes grid on touch viewset", async () => {
                let result = await injector.require(["GUIAPP/content/views/script/accountselection", "mocks"]);
                let accountSelection = result[0];
                let mocks = result[1];
                ...
                accountSelection.compositionUpdated();
