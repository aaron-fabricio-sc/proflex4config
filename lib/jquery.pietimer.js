 ...
 * Modified & enhanced by Markus Schniedermeyer
 *
    ...
    var methods = {
        ...
        stopWatch: function() {
            ...
            if(data) {
                ...
                if(seconds <= 0) {
                    ...
                    $(this).pietimer('drawTimer', 100, seconds);
                    data.callback();
                }
                else {
        ...
        drawTimer: function(percent, seconds) {
            ...
            if(data) {
                ...
                let timerValue = $this.find('.percent');
                if(data.showPercentage) {
                    timerValue.html(Math.round(percent) + '%');
                    timerValue.show();
                }
                else if(data.showSeconds) {
                    seconds = seconds > 0 ? seconds : 0;
                    timerValue.html(Math.round(seconds) + 's');
                    timerValue.show();
                }
